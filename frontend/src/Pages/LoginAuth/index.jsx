      ...
      <div className="min-h-[100vh] flex items-center justify-center bg-gray-900 p-4">
        <div className="w-full max-w-md bg-white shadow-2xl rounded-lg overflow-hidden p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600">We're happy to see you again.</p>
          </div>
          ...
          <div className="flex items-center justify-end mt-5 text-sm mb-2">
            <Link to="/auth/reset-password" className="font-medium hover:underline text-purple-400">
              Forgot Password?
            </Link>
          </div>
          <button
            onClick={handleLogin}
            disabled={isLoading}
            className="w-full mt-6 mb-4 py-3 bg-gradient-to-r from-purple-600 to-blue-500 text-white font-bold rounded-lg transition-opacity hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-center text-sm text-gray-800 mt-6">
            ...
            <Link to="/auth/register" className="font-medium hover:underline text-purple-400">
              Register here
            </Link>
          </p>
